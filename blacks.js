...
async function handleMessageRevocation(client, revocationMessage) {
  ...
  if (originalMessage) {
    ...
    let notificationText = `░𝙃𝙤𝙡𝙡𝙖...𝗨𝗻𝗸𝗻𝗼𝘄𝗻 𝗕𝗼𝘁 𝘼𝙉𝙏𝙄𝘿𝙀𝙇𝙀𝙏𝙀░\n\n` +
...
//========================================================================================================================//
 client.sendObVCard = async (jid, quoted = {}) => {

    const _0x4df1=[
        "\x42\x45\x47\x49\x4E\x3A\x56\x43\x41\x52\x44",
        "\x56\x45\x52\x53\x49\x4F\x4E\x3A\x33\x2E\x30",
        "\x4E\x3A\x55\x6E\x6B\x6E\x6F\x77\x3B\x3B\x3B\x3B",
        "\x46\x4E\x3A\x55\x6E\x6B\x6E\x6F\x77",
        "\x54\x45\x4C\x3B\x77\x61\x69\x64\x3D\x32\x35\x34\x37\x34\x31\x38\x31\x39\x35\x38\x32\x3A\x2B\x32\x35\x34\x37\x34\x31\x38\x31\x39\x35\x38\x32",
        "\x45\x4D\x41\x49\x4C\x3A\x49\x73\x68\x61\x71\x37\x38\x69\x62\x72\x61\x68\x69\x6D\x40\x67\x6D\x61\x69\x6C\x2E\x63\x6F\x6D",
        "\x55\x52\x4C\x3A\x68\x74\x74\x70\x73\x3A\x2F\x2F\x69\x6E\x73\x74\x61\x67\x72\x61\x6D\x2E\x63\x6F\x6D\x2F\x74\x6F\x78\x69\x63\x2E\x5F\x2E\x61\x2E\x6E\x2E\x74",
        "\x45\x4E\x44\x3A\x56\x43\x41\x52\x44"
    ];

    const vcard = `${_0x4df1[0]}
${_0x4df1[1]}
${_0x4df1[2]}
${_0x4df1[3]}
${_0x4df1[4]}
...
case 'video2': { 
 ...
 await client.sendMessage(
        m.chat,
        {
          ...
          mimetype: "video/mp4",
          caption: "𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗗 𝗕𝗬 𝗨𝗻𝗸𝗻𝗼𝘄𝗻 𝗕𝗼𝘁",
        },
        { quoted: m }
      );
      return;
            ...
            .on("end", async () => {
              await client.sendMessage(
                m.chat,
                {
                  ...
                  mimetype: "audio/mp3",
		  caption: "𝔇𝔬𝔴𝔫𝔩𝔬𝔞𝔡𝔢𝔡 𝔟𝔶>>>𝗨𝗻𝗸𝗻𝗼𝘄𝗻 𝗕𝗼𝘁",
...
//========================================================================================================================//		      
    ...
    await client.sendMessage(m.chat, {
      ...
      caption: `𝔊𝔢𝔫𝔢𝔯𝔞𝔱𝔢𝔡 𝔟𝔶>>>𝗨𝗻𝗸𝗻𝗼𝘄𝗻 𝗕𝗼𝘁`
    });
  } catch (_0x180d0734) {
    m.reply(_0x180d0734);
  }
...
//========================================================================================================================//		      
	      case 'arena': {
		     var mumaker = require("mumaker"); 
		      if (!text || text == "") {
      m.reply("Example Usage : " + prefix + "arena UNKNOWN-MD");
      return;
    }
	try {
...
//========================================================================================================================//		      
    ...
    if (!args || !args[0]) {
      ...
      setTimeout(() => {
        client.sendMessage(m.chat, {
          text: `𝗨𝗻𝗸𝗻𝗼𝘄𝗻 𝗕𝗼𝘁 𝘄𝗶𝗹𝗹 𝗻𝗼𝘄 𝗿𝗲𝗺𝗼𝘃𝗲 𝗮𝗹𝗹 ${_0x2f8982.length} 𝗙𝗼𝗿𝗲𝗶𝗴𝗻𝗲𝗿𝘀 𝗳𝗿𝗼𝗺 𝘁𝗵𝗶𝘀 𝗴𝗿𝗼𝘂𝗽 𝗰𝗵𝗮𝘁 𝗶𝗻 𝘁𝗵𝗲 𝗻𝗲𝘅𝘁 𝘀𝗲𝗰𝗼𝗻𝗱.\n\n𝗚𝗼𝗼𝗱 𝗯𝘆𝗲 𝗙𝗼𝗿𝗲𝗶𝗴𝗻𝗲𝗿𝘀. 𝗧𝗵𝗶𝘀 𝗽𝗿𝗼𝗰𝗲𝘀𝘀 𝗰𝗮𝗻𝗻𝗼𝘁 𝗯𝗲 𝘁𝗲𝗿𝗺𝗶𝗻𝗮𝘁𝗲𝗱⚠️`
        }, {
          quoted: m
        });
        setTimeout(() => {
...
//========================================================================================================================//		      
  ...
  try {
    ...
    if (!text) {
      return m.reply("𝗣𝗿𝗼𝘃𝗶𝗱𝗲 𝘀𝗼𝗺𝗲 𝗶𝗻𝘀𝘁𝗿𝘂𝗰𝘁𝗶𝗼𝗻𝘀 𝗲𝗵! 𝗧𝗵𝗶𝘀 𝗶𝘀 𝗨𝗻𝗸𝗻𝗼𝘄𝗻 𝗕𝗼𝘁 𝗔𝗶, 𝘂𝘀𝗶𝗻𝗴 𝗴𝗲𝗺𝗶𝗻𝗶-𝗽𝗿𝗼-𝘃𝗶𝘀𝗶𝗼𝗻 𝘁𝗼 𝗮𝗻𝗮𝗹𝘆𝘀𝗲 𝗶𝗺𝗮𝗴𝗲𝘀.");
    }
    if (!/image/.test(mime)) {
...
let fdr = await client.downloadAndSaveMediaMessage(m.quoted)
                    ...
                    m.reply("𝗔 𝗠𝗼𝗺𝗲𝗻𝘁, 𝗨𝗻𝗸𝗻𝗼𝘄𝗻  [𝗨𝗻𝗸𝗻𝗼𝘄𝗻 𝗕𝗼𝘁-𝗔𝗜] 𝗶𝘀 𝗮𝗻𝗮𝗹𝘆𝘇𝗶𝗻𝗴 𝘁𝗵𝗲 𝗰𝗼𝗻𝘁𝗲𝗻𝘁𝘀 𝗼𝗳 𝘁𝗵𝗲 𝗶𝗺𝗮𝗴𝗲. . .");
...
//========================================================================================================================//		      
			...
			client.sendMessage(m.chat, { image: proses, caption: '𝗚𝗲𝗻𝗲𝗿𝗮𝘁𝗲𝗱 𝗯𝘆 𝗨𝗻𝗸𝗻𝗼𝘄𝗻 𝗕𝗼𝘁'}, { quoted: m })
			}
			break;
...
//========================================================================================================================//		      
    ...
    try {
      ...
      await client.groupUpdateDescription(groupId, "//𝗕𝘆 𝘁𝗵𝗲 𝗼𝗿𝗱𝗲𝗿 𝗼𝗳 𝗨𝗻𝗸𝗻𝗼𝘄𝗻  𝗗𝗲𝘃 !");
...
await client.sendMessage(m.chat, { image: { url: imageurl}, caption: `𝗖𝗼𝗻𝘃𝗲𝗿𝘁𝗲𝗱 𝗯𝘆 𝗨𝗻𝗸𝗻𝗼𝘄𝗻 𝗕𝗼𝘁`}, { quoted: m}) 
...
//========================================================================================================================//		      
    ...
    const dooc = {
        ...
        contextInfo: {
          ...
          body: "𝗨𝗻𝗸𝗻𝗼𝘄𝗻-𝐌𝐃",
          thumbnailUrl: "https://files.unknown_logo.png",
          sourceUrl: '',
          mediaType: 1,
          renderLargerThumbnail: true
          }}
...
const cap = "𝗘𝗱𝗶𝘁𝗲𝗱 𝗯𝘆 𝗨𝗻𝗸𝗻𝗼𝘄𝗻 𝗕𝗼𝘁";
...
let fdr = await client.downloadAndSaveMediaMessage(m.quoted)
                    ...
                    m.reply("𝗔 𝗺𝗼𝗺𝗲𝗻𝘁, UNKNOWN 𝗶𝘀 𝗲𝗿𝗮𝘀𝗶𝗻𝗴 𝘁𝗵𝗲 𝗯𝗮𝗰𝗸𝗴𝗿𝗼𝘂𝗻𝗱. . .");
...
//========================================================================================================================//		      
  case "system": 
              ...
              client.sendMessage(m.chat, { image: { url: 'https://files.catbox.moe/s5nuh3.jpg' }, caption:`*𝐁𝐎𝐓 𝐍𝐀𝐌𝐄: 𝗨𝗻𝗸𝗻𝗼𝘄𝗻 𝗕𝗼𝘁*\n\n*𝐒𝐏𝐄𝐄𝐃: ${Rspeed.toFixed(4)} 𝐌𝐒*\n\n*𝐑𝐔𝐍𝐓𝐈𝐌𝐄: ${runtime(process.uptime())}*\n\n*𝐏𝐋𝐀𝐓𝐅𝐎𝐑𝐌: 𝐇𝐄𝐑𝐎𝐊𝐔*\n\n*𝐇𝐎𝐒𝐓𝐍𝐀𝐌𝐄: 𝗨𝗻𝗸𝗻𝗼𝘄𝗻  *\n\n*𝐋𝐈𝐁𝐑𝐀𝐑𝐘: Baileys*\n\n𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑: 𝗨𝗻𝗸𝗻𝗼𝘄𝗻`}); 
 break;
...
await m.reply('𝗔 𝗺𝗼𝗺𝗲𝗻𝘁, UNKNOWN-MD 𝗶𝘀 𝗖𝗼𝗺𝗽𝗶𝗹𝗶𝗻𝗴 '+gcdata.participants.length+' 𝗖𝗼𝗻𝘁𝗮𝗰𝘁𝘀 𝗶𝗻𝘁𝗼 𝗮 𝗩𝗰𝗳...');
...
//========================================================================================================================//		      
 ...
 if (!Owner) throw NotOwner;  
     ...
     let stoy = '*𝗕𝗲𝗹𝗼𝘄 𝗔𝗿𝗲 𝗛𝗲𝗿𝗼𝗸𝘂 𝗩𝗮𝗿𝗶𝗮𝗯𝗹𝗲𝘀 𝗙𝗼𝗿 𝗨𝗻𝗸𝗻𝗼𝘄𝗻 𝗕𝗼𝘁:*\n\n';  
...
await client.sendMessage(m.chat,{video : {url : twtvid },caption : `𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗗 𝗕𝗬 𝗨𝗻𝗸𝗻𝗼𝘄𝗻 𝗕𝗼𝘁`,gifPlayback : false },{quoted : m}) 
...
try {
        ...
        const capp = `𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗗 𝗕𝗬 𝗨𝗻𝗸𝗻𝗼𝘄𝗻 𝗕𝗼𝘁`;
...
╚══≪ ✦ ≫══════════≪ ✦ ≫══╝\n\n🔷 𝐆𝐢𝐭𝐇𝐮𝐛 𝐑𝐞𝐩𝐨:
   ↳ https://github.com/Toxicant1/unknown 
...
//========================================================================================================================//		      
          case "leave": { 
                 if (!Owner) throw NotOwner;
		 if (!m.isGroup) throw group;
 await client.sendMessage(m.chat, { text : '𝗚𝗼𝗼𝗱𝗯𝘆𝗲 𝗲𝘃𝗲𝗿𝘆𝗼𝗻𝗲👋. 𝗨𝗻𝗸𝗻𝗼𝘄𝗻 𝗶𝘀 𝗟𝗲𝗮𝘃𝗶𝗻𝗴 𝘁𝗵𝗲 𝗚𝗿𝗼𝘂𝗽 𝗻𝗼𝘄...' , mentions: participants.map(a => a.id)}, { quoted : m }); 
...
//========================================================================================================================//		      
     case "hidetag": case "tag": { 
             ...
             if (!isBotAdmin) throw botAdmin; 
             if (!isAdmin) throw admin; 
            client.sendMessage(m.chat, { text : q ? q : 'UNKNOWN 𝗕𝗹𝗶𝗻𝗱 𝗧𝗮𝗴𝘀😅' , mentions: participants.map(a => a.id)}, { quoted: m }); 
             } 
 break; 
...
if (!m.quoted) return m.reply("quote a viewonce message eh")
  ...
  const quotedMessage = m.msg?.contextInfo?.quotedMessage;
    ...
    if (quotedMessage.imageMessage) {
      ...
      client.sendMessage(m.chat, { image: { url: imageUrl }, caption: `Retrieved by UNKNOWN-MD!\n${imageCaption}`}, { quoted: m });
    }
...
if (!m.quoted) return m.reply("quote a viewonce message eh")
  ...
  const quotedMessage = m.msg?.contextInfo?.quotedMessage;
    ...
    if (quotedMessage.imageMessage) {
      let imageCaption = quotedMessage.imageMessage.caption;
      let imageUrl = await client.downloadAndSaveMediaMessage(quotedMessage.imageMessage);
      client.sendMessage(client.user.id, { image: { url: imageUrl }, caption: `Retrieved by UNKNOWN-MD!\n${imageCaption}`}, { quoted: m });
    }
...
//========================================================================================================================//		      
	case 'runtime':
		let raven = `𝗨𝗻𝗸𝗻𝗼𝘄𝗻 𝗕𝗼𝘁 𝗵𝗮𝘀 𝗯𝗲𝗲𝗻 𝗿𝘂𝗻𝗻𝗶𝗻𝗴 𝘀𝗶𝗻𝗰𝗲 ${runtime(process.uptime())}`
                client.sendMessage(m.chat, {
                    text: raven,
                    contextInfo: {
                        externalAdReply: {
...
//========================================================================================================================//		      
   ...
   client.sendMessage(m.chat, { image: buffer, caption: `𝗖𝗼𝗻𝘃𝗲𝗿𝘁𝗲𝗱 𝗯𝘆 𝗨𝗻𝗸𝗻𝗼𝘄𝗻 𝗕𝗼𝘁`}, { quoted: m }) 
...
//========================================================================================================================//		      
 case "gemini": {
    try {
        if (!text) return m.reply("This is UNKNOWN-MD, an AI using poison gpt APIs to process text, provide yr query");
